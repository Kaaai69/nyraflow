// Основано на компоненте Khoa Phan <https://www.pldkhoa.dev>.
// Отличие от оригинала: импорт из framer-motion, который уже стоит в проекте,
// вместо отдельного пакета motion.
